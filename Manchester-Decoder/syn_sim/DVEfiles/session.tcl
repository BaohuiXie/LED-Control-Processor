...
# DVE full session
# Saved on Fri May 6 13:34:41 2022
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 210} {height 508} {dock_state left} {dock_on_new_line true} {child_hier_colhier 306} {child_hier_coltype 10} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 270]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 1647
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 270
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1699} {height 269} {dock_state bottom} {dock_on_new_line true}}
...
gui_open_source -id ${Source.1}  -replace -active decoder_tb /afs/ee.ust.hk/staff/ee/bxieaf/eesm6980/implementation_8Update/syn_sim/../tb/decoder_tb.v
