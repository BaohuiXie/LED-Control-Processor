...
# DVE full session
# Saved on Fri Apr 29 02:43:25 2022
# Designs open: 1
#   Sim: /afs/ee.ust.hk/staff/ee/bxieaf/eesm6980/implementation_9/syn_sim/simv
# Toplevel windows open: 1
# 	TopLevel.1
#   Source.1: encoder_tb
#   Schematic.1: encoder_tb.uut2.IDLEdetection1.comp1
#   Schematic.2: encoder_tb.uut2.FSM1
#   Schematic.3: encoder_tb.uut2.DIV8CLK1
#   Group count = 0
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 270} {height 601} {dock_state left} {dock_on_new_line true} {child_hier_colhier 306} {child_hier_coltype 10} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1695} {height 172} {dock_state bottom} {dock_on_new_line true}}
...
gui_sch_show -window ${Schematic.1} -name encoder_tb.uut2.IDLEdetection1.comp1
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.1}]
gui_zoom -window ${Schematic.1} -rect { {-21781 -44200} {92388 4265} }
...
gui_sch_show -window ${Schematic.2} -name encoder_tb.uut2.FSM1
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.2}]
gui_zoom -window ${Schematic.2} -rect { {-1159 -62995} {210056 26665} }
...
gui_sch_show -window ${Schematic.3} -name encoder_tb.uut2.DIV8CLK1
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.3}]
gui_zoom -window ${Schematic.3} -rect { {-1036 -57068} {156942 9994} }
